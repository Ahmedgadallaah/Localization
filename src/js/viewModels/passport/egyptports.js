...
define(['ojs/ojcore', 'knockout', 'jquery',
  ...
  function (oj, ko, $, ipConfig, fetchAllDataClass) {
    ...
    function EgyptPorts() {
      ...
      // self.url = 'http://' + ipConfig.firstOctet + '.' + ipConfig.secondOctet + '.' + ipConfig.thirdOctet + '.' + ipConfig.fourthOctet + ':' + ipConfig.portNumber + '/PASSPORTS_PORTS_SBProject/PortsEgyMovsRestService';
      ...
      self.doSearch = function () {
        ...
        self.fetchAllData.getData(self.errorMessages).then(function (values) {
          var info = values[0];
          if (info.isOK) self.redrivedData(info.data.portsEgyMovsOutput);
        })
      }
      ...
      self.connected = function () {
        //console.log("URL Service Egypt Ports", self.url)
        self.doSearch();
      }
