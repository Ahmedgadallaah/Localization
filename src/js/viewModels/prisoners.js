...
define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojmodule-element-utils',
    ...
    function (oj, ko, $, moduleUtils, app) {
        ...
        function PrisonersViewModel() {
            ...
            self.subRouter = self.parentRouter.createChildRouter('prisoner');
            ...
            self.refreshModule = function (moduleName) {
                var viewPath = 'views/prison/' + moduleName + '.html';
                var modelPath = 'viewModels/prison/' + moduleName;
